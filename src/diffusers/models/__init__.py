...
if is_torch_available():
    ...
    _import_structure["autoencoders.autoencoder_kl_FluxRewardFlow"] = ["AutoencoderKLFluxRewardFlow"]
    ...
    _import_structure["transformers.transformer_FluxRewardFlow"] = ["FluxRewardFlowTransformer2DModel"]
