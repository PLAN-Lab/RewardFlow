...
class FluxRewardFlowImageProcessor(VaeImageProcessor):
    r"""
    Image processor to preprocess the reference (character) image for the FluxRewardFlow model.
    ...
    def _resize_if_exceeds_area(image, target_area=1024 * 1024) -> PIL.Image.Image:
        ...
        if pixel_count <= target_area:
            return image
        return FluxRewardFlowImageProcessor._resize_to_target_area(image, target_area)
    ...
    # Taken from
    # https://github.com/black-forest-labs/FluxRewardFlow/blob/5a5d316b1b42f6b59a8c9194b77c8256be848432/src/FluxRewardFlow/sampling.py#L310C1-L339C19
    @staticmethod
